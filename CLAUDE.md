...
- **Próximo passo: Etapa 6** — plano aprovado em `planejamento/etapa-6-conta-edicao-redesign.md`. Nasceu de três reclamações do usuário: (1) não existe cadastro de verdade, (2) dá para criar e nunca desfazer, (3) o front está feio. Decisões já fechadas com ele: **código de convite gerado pelo líder, com validade e limite de usos** (nada depende de e-mail); **cadastro sem confirmação** de e-mail; **arquivar o que tem histórico** e excluir de vez só o que nunca foi usado; paleta **azul-petróleo `#0F766E` + cinza**, fonte **Inter**; movimento **"vivo + efeitos de superfície"** (vidro, gradiente, glow, mola), respeitando `prefers-reduced-motion`. Três etapas; a fundação visual vem junto com a Etapa 1 porque toda tela nova precisa nascer em cima dela.
- O app nativo com Expo/React Native (a "Fase 6" do `planejamento/planejamento.md`) fica para **depois** da Etapa 6.
